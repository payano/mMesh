...
//    spi->transfernb( (uint8_t *) spi_txbuff, (uint8_t *) spi_rxbuff, size);
//
...
//    spi->transfernb( (uint8_t *) spi_txbuff, (uint8_t  *) spi_rxbuff, 2);
...
{
//	int yolo = read_register(FIFO_STATUS) & _BV(RX_EMPTY);
//    if (yolo) {
...
//    }
//
//    spi->transfern( (uint8_t *) spi_txbuff, size);
//    endTransaction();
//    #else
    beginTransaction();
